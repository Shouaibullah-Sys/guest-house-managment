...
import { guestFormSchema, GuestFormData } from "@/lib/validation/guest";
...
export function GuestForm({
  ...
  // Create the form with explicit typing
  ...
  const handleFormSubmit = async (data: GuestFormData) => {
    ...
    try {
      ...
      await onSubmit(cleanedData as GuestFormData);
    } catch (error) {
      setServerError(
  ...
  return (
    <Form {...form}>
      ...
      >
        ...
        {/* Main Two-Column Grid for Desktop */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
          ...
          <div className="space-y-6">
            ...
            <Card>
              <CardHeader className="pb-3">
                ...
                <CardDescription>اطلاعات اصلی و تماس میهمان</CardDescription>
              </CardHeader>
                    ...
                    <FormItem>
                      ...
                      >
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="driving_license">لیسنس</SelectItem>
          ...
          <div className="space-y-6">
              ...
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <CardDescription>اطلاعات مخاطب عاجل میهمان</CardDescription>
                  </div>
                  <Button
                    type="button"
                    variant="outline"
              ...
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between">
                  ...
                  <Button
                    ...
                    size="sm"
                    onClick={
                      showPreferences ? removePreferences : addPreferences
                    }
                  >
                    {showPreferences ? (
                      <>
            ...
            {/* Active Status Card (for edit mode) */}
            {mode === "edit" && (
              <Card>
        ...
        {/* Submit Button - Below the two-column grid */}
