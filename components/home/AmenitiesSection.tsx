  ...
  const amenities: Amenity[] = [
    {
      ...
      name: "Infinity Pool",
      description: "Stunning ocean-view infinity pool with private cabanas",
      category: "premium",
      featured: true,
    },
    {
      ...
      name: "Premium WiFi",
      description: "High-speed fiber optic internet throughout property",
      category: "technology",
    },
    {
      icon: <Coffee className="w-6 h-6" />,
      name: "24/7 Gourmet Dining",
      description: "24-hour room service with Michelin-inspired cuisine",
      category: "dining",
      featured: true,
    },
    {
      ...
      name: "Butler Service",
      description: "Personal butler available 24/7 for all your needs",
      category: "service",
      featured: true,
    },
    {
      ...
      description: "Complimentary luxury car service within city limits",
      category: "transport",
    },
    {
    ...
    },
    {
      ...
      description: "Private members lounge with premium beverages",
      category: "entertainment",
    },
    {
      icon: <Umbrella className="w-6 h-6" />,
      name: "Private Beach",
      description: "Reserved beach area with dedicated attendants",
      category: "premium",
      featured: true,
    },
    {
      ...
      description: "Voice-controlled rooms with 4K entertainment systems",
      category: "technology",
    },
    {
      icon: <Wind className="w-6 h-6" />,
      name: "Climate Control",
      description: "Individual room climate and air purification systems",
      category: "comfort",
    },
    {
      icon: <Bath className="w-6 h-6" />,
      name: "Spa Bathrooms",
      description: "Heated floors, rain showers, and luxury toiletries",
      category: "wellness",
    },
    {
      icon: <Shield className="w-6 h-6" />,
      name: "Advanced Security",
      description: "24/7 security with biometric access control",
      category: "safety",
    },
    {
      icon: <Clock className="w-6 h-6" />,
      name: "Flexible Check-in/out",
      description: "Early check-in and late check-out upon availability",
      category: "service",
    },
    {
      icon: <Heart className="w-6 h-6" />,
      name: "Medical Services",
      description: "On-call doctor and emergency medical assistance",
      category: "safety",
    },
    {
      icon: <Globe className="w-6 h-6" />,
      name: "Concierge Services",
      description: "Personalized itinerary planning and reservations",
      category: "service",
    },
    {
      icon: <Users className="w-6 h-6" />,
      name: "Business Center",
      description: "Fully equipped with meeting rooms and tech support",
      category: "business",
    },
  ];
