...
import { Search, Plus, UserPlus, Calendar, Phone } from "lucide-react";
import {
  Patient,
  Doctor,
  LaboratoryTest,
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="container mx-auto flex-grow p-4">
        <div className="mb-6">
          {/* Updated text colors to use semantic variables */}
        ...
        {/* Cards will now use the laboratory color palette automatically */}
        <Card className="mb-6">
          <CardHeader>
