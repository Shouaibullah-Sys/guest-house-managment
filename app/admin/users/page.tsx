...
export default function UserManagementPage() {
  ...
  const handleSetRole = async (userId: string, role: "guest" | "staff" | "admin") => {
  ...
  const handleToggleStatus = async (userId: string, isActive: boolean) => {
    ...
    const endpoint = isActive ? "/api/admin/users/disable" : "/api/admin/users/enable";
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div className="flex gap-2">
                <Button onClick={() => fetchUsers(pagination.page)} disabled={isLoading} className="flex-1">
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="border-b bg-gray-50">
                        ...
                        <th className="p-4 text-left font-medium text-gray-700">Last Sign In</th>
                            ...
                            <td className="p-4">
                              <DropdownMenu>
                                ...
                                <DropdownMenuContent align="end">
                                  ...
                                  {!user.publicMetadata.approved && !user.banned && user.isActive && (
                                  ...
                                  <DropdownMenuItem
                                    ...
                                    disabled={user.publicMetadata.role === "guest"}
                                  >
                                    Set as Guest
                                  </DropdownMenuItem>
                                  ...
                                  <DropdownMenuItem
                                    ...
                                    disabled={user.publicMetadata.role === "staff"}
                                  >
                                    Set as Staff
                                  </DropdownMenuItem>
                                  ...
                                  <DropdownMenuItem
                                    onClick={() => handleToggleStatus(user.id, user.isActive && !user.banned)}
                                    className={user.banned || !user.isActive ? "text-green-600" : "text-red-600"}
                                  >
                                    {user.banned || !user.isActive ? "Enable User" : "Disable User"}
                                  </DropdownMenuItem>
